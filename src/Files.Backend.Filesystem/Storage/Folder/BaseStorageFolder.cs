...
namespace Files.Backend.Filesystem.Storage
{
    public abstract class BaseStorageFolder : IBaseStorageFolder
    {
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFile>> GetFilesAsync();
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFile>> GetFilesAsync(CommonFileQuery query);
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFile>> GetFilesAsync(CommonFileQuery query, uint startIndex, uint maxItemsToRetrieve);
        IAsyncOperation<IReadOnlyList<StorageFile>> IStorageFolderQueryOperations.GetFilesAsync
                (CommonFileQuery query, uint startIndex, uint maxItemsToRetrieve)
            => AsyncInfo.Run<IReadOnlyList<StorageFile>>(async (cancellationToken)
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFolder>> GetFoldersAsync();
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFolder>> GetFoldersAsync(CommonFolderQuery query);
        ...
        public abstract IAsyncOperation<IEnumerable<IBaseStorageFolder>>GetFoldersAsync(CommonFolderQuery query, uint startIndex, uint maxItemsToRetrieve);
